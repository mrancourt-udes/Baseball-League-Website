      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li><a href="Equipes">Liste des équipes</a></li>
            <li><a href="Equipes">Supprimer une équipe</a></li>

            <%--Joueurs--%>
            <li class="divider"></li>
            <li><a href="/Routes?page=ajouterJoueur">Ajouter un joueur</a></li>
            <li><a href="Joueurs">Liste de joueurs</a></li>
            <li><a href="Joueurs">Supprimer un joueur</a></li>
            ...
            <li><a href="Matchs">Résultats des matchs</a></li>

            <%--Arbitre--%>
            <li class="divider"></li>
            <li><a href="/Routes?page=ajouterArbitre">Ajouter un arbitre</a></li>
            <li><a href="Arbitres">Liste de arbitres</a></li>
